...
// Lookup requested Timesheet and attaching to subsequent middleware
...
// Get all Employee related Timesheets
...
timesheetsRouter.post('/', (req, res, next) => {
  const hours = req.body.timesheet.hours, rate = req.body.timesheet.rate, date = req.body.timesheet.date;
  if(!hours || !rate || !date){
